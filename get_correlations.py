...
RESULTS_CSV = os.path.join(current_dir, 'results', 'correlations')
...
if __name__ == '__main__':
    ...
    tester = Codec_Tester(data_loader = data_loader_test, 
                                device = device, 
                                max_val = 1,
    ...
    path_indv = os.path.join(RESULTS_CSV, 'correlations_indivual.csv')
    path_avg_png = os.path.join(RESULTS_CSV, 'correlations_avg.png')
    path_indv_png = os.path.join(RESULTS_CSV, 'correlations_indivual.png')
